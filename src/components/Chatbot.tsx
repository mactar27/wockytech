...
function Bubble({ message }: { message: UIMessage }) {
  ...
  return (
    ...
    >
      {isBot && (
        <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-border p-1 overflow-hidden">
          <Image src="/wocky_icon.png" alt="Wocky" width={24} height={24} className="size-full rounded-full object-contain" />
        </span>
      )}
      <div
          ...
          >
            <div className="flex items-center gap-3 bg-brand-navy px-4 py-3.5">
              <span className="relative flex size-10 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-white/10 p-1 overflow-hidden">
                <Image src="/wocky_icon.png" alt="Wocky" width={28} height={28} className="size-full rounded-full object-contain" />
            ...
            <div className="min-h-0 flex-1 space-y-3 overflow-y-auto px-4 py-4 bg-white">
              ...
              <AnimatePresence>
                {isLoading && (
                  ...
                  >
                    <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-white shadow-sm ring-1 border-gray-200 p-1 overflow-hidden">
                      <Image src="/wocky_icon.png" alt="Wocky" width={24} height={24} className="size-full rounded-full object-contain" />
                    </span>
      ...
      >
        ...
        <AnimatePresence mode="wait" initial={false}>
          {open ? (
            ...
            >
              <Image src="/wocky_icon.png" alt="Wocky" width={40} height={40} className="size-full rounded-full object-contain" priority />
            </motion.span>
          )}
        </AnimatePresence>
