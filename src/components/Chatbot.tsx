    ...
    messages: [
      {
        ...
        parts: [
          {
            type: "text",
            text: "Bonjour 👋 Je suis l'assistant IA de WockyTech. Comment puis-je vous aider ?",
          },
        ],
      },
    ],
  ...
  return (
    <div className="fixed bottom-6 right-5 z-[110] flex flex-col items-end gap-3">
          ...
          >
            <div className="flex items-center gap-3 bg-brand-navy px-4 py-3.5">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold leading-tight text-white">Assistant WockyTech</p>
      ...
      <motion.button
        ...
        className="relative flex size-14 items-center justify-center rounded-full bg-brand-navy text-white shadow-xl shadow-brand-navy/30"
      >
        {!open && (
          <motion.span
